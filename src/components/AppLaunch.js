          ...
          <div className="swapRouteModal_content">
            <div className="modal-swapRoute-container">
              <div className="swaproute-header">
                ...
                <div className="swaproute-close-btn" onClick={handleSwapRouteModalCloseClick}>
              ...
              <div className="swaproute-body">
                <div className="swaproute-action-btn">
                  <button
                    className={
                      swapRouteActions === "Max Return" ? "active" : ""
                    }
                        ...
                        <div className="route-container route-1 active">
                          ...
                          <div className="route-body">
                            ...
                            <div className="swaprouteto">
                              2098.444 DAI{" "}
                              <span id="location">on Avalanche</span>
                            </div>
                          </div>
                        </div>
                      </div>
                              ...
                              <div className="row">
                                <div className="col-12">
                                  <div className="1_ETH">
                                    <p>
                                      1 ETH ={" "}
                                      <span id="price">1,788.46456</span> DAI
                                    </p>
                                  </div>
                                </div>
                                <div className="col-12">
